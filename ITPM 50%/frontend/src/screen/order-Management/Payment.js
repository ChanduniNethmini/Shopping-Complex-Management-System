...
export default class Payment extends Component {
    ...
    onToken = (token) => {
        // Process the token, for example, you can send it to your server for payment processing
        // Here, you can call your API to save the token or perform any other action
        console.log(token); // You can handle the token here
    }
