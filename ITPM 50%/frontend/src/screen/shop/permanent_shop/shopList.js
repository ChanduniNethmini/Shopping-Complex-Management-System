...
import { AppBar, Toolbar, Typography, IconButton, Button, Card, CardActionArea, CardContent, CardMedia, Grid } from '@material-ui/core';
        ...
        <div className={classes.root}>
            ...
            <div className={classes.container}>
                <div className={classes.subContainer}>
                    <Typography variant="h4" className={classes.appTitle}> Permanent Shops</Typography>
                    <hr/>
                                ...
                                <Card className={classes.card}>
                                    <CardActionArea component={Link} to={`/shop`}>
                                        ...
                                        <CardContent>
                                            ...
                                            <Button variant="contained" color="primary" component={Link} to={`/shop`} onClick={() => { localStorage.setItem('shop', shop.shopID); localStorage.setItem('shopName', shop.shopName) }}>
                                                Shop Now
                                            </Button>
                                        </CardContent>
                                    </CardActionArea>
